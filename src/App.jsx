    ...
    return (
      <div className="app-container" style={{ zIndex: 10 }}>
        ...
        <header style={{ position: 'relative', width: '100%' }}>
          <button
            onClick={toggleTheme}
            style={{ position: 'absolute', right: 0, top: 0, background: 'transparent', border: 'none', cursor: 'pointer', zIndex: 20, transition: 'transform 0.2s', padding: 0, color: 'var(--text-light)' }}
            title={isLightMode ? 'Zum Darkmode wechseln' : 'Zum Hellmodus wechseln'}
            onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.1)'}
            onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}
          >
            <svg viewBox="0 0 100 50" width="3.5em" height="1.75em" style={{ overflow: 'visible' }}>

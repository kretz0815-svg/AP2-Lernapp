...
${input}`;
  ...
  const wisorQuestionIdSet = new Set(wisorQuestions.map((q) => q.id));
  const wisorLearnedCount = Object.keys(completedWisors || {}).reduce((count, id) => (
    count + (wisorQuestionIdSet.has(id) ? 1 : 0)
  ), 0);

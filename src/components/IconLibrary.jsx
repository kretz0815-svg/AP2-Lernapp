...
export const PomodoroIcon = ({ size = "1.4em", className = "", style = {} }) => (
    <svg viewBox="0 0 100 100" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const SettingsIcon = ({ size = "1.4em", className = "", style = {} }) => (
...
export const InfoIcon = ({ size = "1.4em", className = "", style = {} }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
